package com.example.securityguard.db.dao;
...
import com.example.securityguard.db.BlackNumberOpenHelper;
...
public class BlackNumberDao {
	...
	public void delete(String phone) {
		...
		db.delete("blacknumber", "phone = ?", new String[] {});
		db.close();
	}
	...
	/**
	 * @return 数据库中数据的总条目个数,返回0代表没有数据或者异常
	 */
	public int getCount() {
		SQLiteDatabase db = blackNumberOpenHelper.getWritableDatabase();
		int count = 0;
	 ...
	 * @return 传入电话号码的拦截模式 1:短信2:电话3:所有0:没有此条数据
	 */
